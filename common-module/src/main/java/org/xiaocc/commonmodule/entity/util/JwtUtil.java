package org.xiaocc.commonmodule.entity.util;
...
public class JwtUtil {
    //用户的用户名
    private static final String USERNAME = "be78e50a-2814-4c9e-89ba-48ca37464664";

    //用于签名加密的密钥，为一个字符串（需严格保密）
    private static final String KEY = "7824c63f-77e9-4664-8269-226f4378593d";
    ...
    public static String getToken(String userId) {
        ...
        headers.put("type", "jwt");   //设置token的type为jwt
